...
class MQ8:
    ...
    def __init__(self, Ro=10):
        ...
        # create an analog input channel on pin 6 for MQ8
        self.chan_MQ8 = AnalogIn(mcp, MCP.P0)
    ...
    def MQ8_Calibration(self):
        ...
        for i in range(self.CALIBRATION_SAMPLE_TIMES):  # take multiple samples
            val += self.MQResistanceCalculation(self.chan_MQ8.value)
    ...
    def MQRead(self):
        ...
        for i in range(self.READ_SAMPLE_TIMES):
            raw_value += self.chan_MQ8.value
            rs += self.MQResistanceCalculation(self.chan_MQ8.value)
